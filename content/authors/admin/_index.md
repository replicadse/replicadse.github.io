...
education:
  courses:
  - course: BAr Applied Computer Science (pending)
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:haw@voidpointergrouo.com'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/HeikoAWeber
- icon: github
  icon_pack: fab
  link: https://github.com/replicadse
